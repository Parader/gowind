...
const items = [
    ...
    },
    {
        ...
        subtitle: "Learn how our customers are using GoWind to 10x their growth.",
...
export const DropdownMenuSimple = () => {
    return (
        <div className="px-3 pb-2 md:max-w-84 md:p-0">
            <nav className="overflow-hidden rounded-2xl bg-white py-2 shadow-xs ring-1 ring-secondary_alt md:p-2 md:shadow-lg dark:bg-primary">
